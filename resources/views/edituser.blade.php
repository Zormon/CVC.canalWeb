...
@section('content')
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" enctype="multipart/form-data" action="{{ route('saveuser.profile',[$user->id]) }}" autocomplete="off" class="needs-validation" novalidate>
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input readonly id="username" type="username" class="form-control{{ $errors->has('username') ? ' is-invalid' : '' }}" name="username" value="{{ $user->username }}" autocomplete="false" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ $user->name }}" required autocomplete="false" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input placeholder="{{ __('Address') }}" id="address" type="text" class="form-control" name="address" value="{{ $user->address }}" autocomplete="false">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea name="notes" id="notes" class="form-control">{{ $user->notes }}</textarea>
                            </div>
                        </div>
