      ...
      <div class="container">
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-lg-5 col-md-6 pt-4 mt-4">
                <a class="navbar-brand" href="{{ route('login') }}">
                    <img src="{{ asset('img/brand/logo_white.png') }}" class="img-fluid" />
                </a>
            <p class="text-lead text-light mt-2">{{__('Acceda a su panel de gestión para administrar los contenidos de sus pantallas')}}</p>
            </div>
          </div>
        </div>
      </div>
              ...
              <div class="row align-items-center justify-content-xl-between">
                ...
                <div class="col-xl-6">
                  <ul class="nav nav-footer justify-content-center justify-content-xl-end">
                    ...
                    <li class="nav-item">
                      <a href="{{ env('APP_COMPANY_URL') }}" class="nav-link" target="_blank">{{ __('About us') }}</a>
                    </li>
                  </ul>
                </div>
              </div>
